...
$user = Auth::user();
$history = bulutangkis::where('user_id', $user->id)->get();
?>
...
<body class="bg-[#3d3d3d]" style="font-family: 'Bebas Neue', cursive;">
  <div class="grid grid-cols-3 justify-evenly">
    ...
    <p class="text-white  text-[65px] justify-self-center">Bulutangkis</p>
  ...
  <form method="POST"  action="{{ config('') }}/bulutangkis" class="bg-[#212121] mt-10 rounded-xl mx-10 text-white text-xl p-4 flex-cols justify-items-center">
    @csrf
